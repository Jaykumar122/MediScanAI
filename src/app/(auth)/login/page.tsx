...
const LoginPage: React.FC = () => {
  ...
  const onLogin = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(
          userRole ? dashboardRoutes[userRole] : "/dashboard/patient",
        );
      }, 500);
    } catch (err) {
    ...
    <WavyBackground className="w-full min-h-screen flex items-center justify-center p-4">
      ...
      >
        <div className="relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-pulse" />
          <div className="relative bg-black/30 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 shadow-2xl">
            ...
            {/* Email & Password Form */}
            <div className="space-y-4 mb-6" onKeyDown={handleKeyPress}>
              {/* Email */}
