  ...
  return (
    <div className="bg-auto h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md relative">
      ...
      <div className="absolute inset-0 z-20 pointer-events-none">
        ...
        <div className="absolute top-32 right-16 text-4xl animate-pulse">
          ⭐
        </div>
        <div className="absolute bottom-32 left-20 text-5xl animate-spin">
          🌟
        </div>
        <div className="absolute bottom-20 right-32 text-3xl animate-bounce">
          🛸
        </div>
        <div className="absolute top-48 left-1/3 text-4xl animate-pulse">
          ✨
        </div>
      </div>
      ...
      {/* Main Content */}
      <div
        className={`flex flex-col items-center justify-center space-y-8 z-30 relative px-4 transition-all duration-1000 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
      >
        {/* Large 404 Display */}
